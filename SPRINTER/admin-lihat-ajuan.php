...
<html lang="en">
    <head>
        ...
        <!-- ====== End ofVendor CSS Files ====== -->

        <!-- ====== Template Main CSS File ====== -->
        <link href="assets/css/admin-style.css" rel="stylesheet">
        <!-- ====== end ofTemplate Main CSS File ====== -->
    </head>
    <body>
        <!-- ====== Header ====== -->
                    ...
                    <ul id="master-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                        ...
                        <li>
                            <a href="admin-master-mkp.php">
                                <i class="bi bi-circle"></i>
                                <span>Master MKP</span>
                            </a>
                        </li>
                        <li>
                            <a href="admin-master-waktu.php">
                                <i class="bi bi-circle"></i>
                                <span>Master WAKTU</span>
                            </a>
                        </li>
                        <li>
        ...
        <main id="main" class="main">
            ...
            <div class="pagetitle">
                <div class="full-bg">
                    ...
                    <nav>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active">Halaman Ajuan</li>
                        </ol>
                    </nav>
                    </div>
                </div>
        ...
        <!-- end ofVendor JS Files -->

        <!-- Template Main JS File -->
        <script src="assets/js/main.js"></script>
        <!-- end of Template Main JS File -->
    </body>
</html>
<?php } ?>