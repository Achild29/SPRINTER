        ...
        <div class="container-fluid w-75 p-5">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <a class="btn btn-success"href="prodi.php" class="btn-success">Master Prodi</a>
                    <a class="btn btn-success"href="mkp.php" class="btn-success">Master MKP</a>
                    <a class="btn btn-success"href="waktu.php" class="btn-success">Master Waktu</a>
                    <a class="btn btn-primary"href="jadwal.php" class="btn-success">Input Jadwal</a>
                </div>
            </div>
        </div>
    <!-- end of Master Prodi -->
