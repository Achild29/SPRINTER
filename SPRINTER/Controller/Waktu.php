...
$arr_hari = array("Senin", "Selasa", "Rabu", "Kamis", "Jumat", "Sabtu K-1", "Sabtu K-2", "Kamis K-1", "Kamis K-2");
$reguler = $_POST['reg'];
$hari = $_POST['hari'];
$jam_mulai = $_POST['jam'];
$jam_selesai_str = strtotime("+100 minutes", strtotime($jam_mulai));
$jam_selesai = date('H:i:s', $jam_selesai_str);
$i = array_search($hari, $arr_hari);
++$i;
$kode_waktu = $i . substr($hari, 0, 3) . $reguler . $jam_mulai;
$msg = "";
